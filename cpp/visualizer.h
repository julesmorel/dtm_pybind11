...
public:
    visualizer(){}
    visualizer(pcl::PointCloud<pcl::PointXYZI> _pointsMin, pcl::PointCloud<pcl::PointXYZ> _pointsRectangleMin, surfaceFrbf _functionalRBFModel);
    void plot();
private:
    ...
    void addSurfaceMesh(pcl::visualization::PCLVisualizer::Ptr viewer ,float deltaZ);
    void addMinPointsConcaveHull(pcl::visualization::PCLVisualizer::Ptr viewer, float z);
};
